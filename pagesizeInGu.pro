...
UBUNTU_TRANSLATION_DOMAIN="pagesizeingu.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pagesizeInGu/tests/autopilot/run
aptest.depends  = sub-pagesizeInGu

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pagesizeInGu/tests/unit
unittest.depends  = sub-pagesizeInGu
